...
def test_maintenance_cycle_finds_multiple_priors():
    ...
    (history_dir / f"{matrix_id}_20260318_000001" / "benchmark_review.json").write_text(json.dumps({"matrix_id": matrix_id, "slices": []}))
    
    (history_dir / f"{matrix_id}_20260318_000002").mkdir()
    (history_dir / f"{matrix_id}_20260318_000002" / "benchmark_review.json").write_text(json.dumps({"matrix_id": matrix_id, "slices": []}))
