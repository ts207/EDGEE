...
def compile_to_nautilus_backtest(
    strategy_spec: StrategySpec, environment: str = "backtest"
) -> Dict[str, Any]:
    """
    ...
    exec_config = map_execution_intent(
        strategy_spec.execution.style, strategy_spec.execution.post_only_preference
    )
...
def compile_to_nautilus_live(
    strategy_spec: StrategySpec, venue_profile: Dict[str, Any]
) -> Dict[str, Any]:
    """
