...
- candidate_count: `13`
- status_counts: `{"needs_repair": 4, "test_now": 9}`
...
- governance: tier `D`, role `trigger`, disposition `review_required`
...
- governance: tier `D`, role `confirm`, disposition `seed_review_required`
- promotion_status: `test_now`
- next_action: `run_seed_tests`
- horizon_guess: `8-24 bars`
- expected_direction_or_path: Expect volatility expansion and directional follow-through after onset.
