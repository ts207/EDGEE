...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'z_threshold': 5.0, 'lookback_window': 288, 'min_basis_bps': 10.0}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 0, 'min_occurrences': 0, 'operational_role': 'trigger', 'window_end': 32, 'anchor_quantile': 0.995, 'revert_z': 0.5, 'basis_lookback': 96, 'persistence_bars': 2, 'min_basis_bps': 35.0}`
- Tags: `['desync']`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'threshold_bps': 2.0, 'funding_quantile': 0.95, 'alignment_window': 3, 'min_basis_bps': 5.0}`
- Tags: `['basis_dislocation']`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 0, 'min_occurrences': 0, 'normalization_lookback': 96, 'min_prior_extreme_abs': 0.0004, 'operational_role': 'trigger', 'funding_pct_window': 2880, 'accel_lookback': 32, 'persistence_bars': 12, 'min_event_spacing': 96, 'vol_burst_quantile': 0.9, 'htf_window': 384, 'htf_lookback': 96, 'pre_window': 96, 'post_window': 96, 'phase_tolerance_bars': 16, 'crossover_confirm_bars': 4, 'accel_quantile': 0.995, 'accel_near_zero_cutoff': 5, 'interaction_min_rows_per_year': 150, 'min_hazard_events': 50}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 24, 'min_occurrences': 0, 'operational_role': 'trigger', 'funding_extreme_quantile': 0.99, 'oi_change_z_threshold': 3.0, 'min_flip_abs': 0.00025, 'persistence_bars': 2, 'min_spacing': 24}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 24, 'min_occurrences': 0, 'operational_role': 'sequence_component', 'max_gap_bars': 96}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'z_threshold': 5.0, 'shock_change_quantile': 0.95, 'lead_lag_window': 60, 'min_basis_bps': 15.0}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 24, 'min_occurrences': 0, 'operational_role': 'filter', 'lookback_window': 2880, 'threshold_z': 3.0, 'min_pair_observations': 96}`
- Tags: `['desync']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'desync_z_threshold': 3.0, 'lead_lag_window': 60}`
- Tags: `['desync']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'spread_z_threshold': 3.0, 'slippage_z_threshold': 3.0}`
- Tags: `['execution_cost']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 48, 'min_occurrences': 0, 'operational_role': 'trigger', 'trend_window': 24, 'lookback_window': 2880, 'min_periods': 288, 'low_volume_quantile': 0.25, 'min_spacing': 48}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 0, 'min_occurrences': 0, 'operational_role': 'trigger', 'liq_multiplier': 3.0, 'median_window': 288}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 96, 'min_occurrences': 0, 'operational_role': 'trigger', 'window': 288, 'spread_quantile': 0.965, 'rv_quantile': 0.9, 'imbalance_abs_quantile': 0.25, 'min_history_bars': 288}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'lookback_window': 288, 'z_threshold': 3.0, 'min_volume_quantile': 0.2}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 96, 'min_occurrences': 0, 'operational_role': 'trigger', 'window': 288, 'spread_quantile': 0.99, 'rv_quantile': 0.9, 'depth_quantile': 0.93, 'min_history_bars': 288}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 0, 'min_occurrences': 0, 'operational_role': 'trigger', 'median_window': 288}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'lookback_window': 288, 'z_threshold': 3.0, 'min_volume_quantile': 0.2, 'ret_quantile': 0.998, 'rv_quantile': 0.92, 'vol_quantile': 0.92, 'ret_window': 288, 'rv_window': 288, 'vol_window': 288, 'min_history_bars': 288}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 24, 'min_occurrences': 0, 'operational_role': 'trigger', 'ret_quantile': 0.995, 'rv_quantile': 0.9, 'volume_quantile': 0.9, 'ret_window': 288, 'rv_window': 288, 'vol_window': 288, 'min_history_bars': 288, 'min_spacing': 24}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 24, 'min_occurrences': 0, 'operational_role': 'sequence_component', 'max_gap_bars': 48}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 0, 'min_occurrences': 0, 'operational_role': 'trigger', 'oi_window': 96, 'spike_z_th': 2.5}`
- Tags: `['oi_dynamic']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 24, 'min_occurrences': 0, 'operational_role': 'trigger', 'funding_extreme_quantile': 0.99, 'oi_change_z_threshold': 3.0}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 48, 'min_occurrences': 0, 'operational_role': 'trigger', 'regime_window': 288, 'transition_z_threshold': 2.5}`
- Tags: `['regime_shift']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'context', 'event_spacing_bars': 288, 'funding_abs_quantile': 0.0}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'context', 'event_spacing_bars': 288}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'context', 'event_spacing_bars': 288, 'session_range_quantile': 0.0, 'session_vol_z_min': None}`
- Tags: `['temporal_anchor']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'lookback_window': 288, 'band_z_threshold': 3.0}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'research_only', 'lookback_window': 288}`
- Tags: `['basis_dislocation']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'lookback_window': 288, 'band_z_threshold': 3.0, 'return_quantile': 0.995}`
- Tags: `['statistical_stretch']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'lookback_window': 288, 'band_z_threshold': 3.0, 'price_quantile': 0.95, 'rv_quantile': 0.95}`
- Tags: `['statistical_stretch']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'lookback_window': 288, 'band_z_threshold': 3.0, 'zscore_quantile': 0.96}`
- Tags: `['statistical_stretch']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'trend_window': 288, 'breakout_z_threshold': 2.5}`
- Tags: `['trend_momentum']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 0, 'min_occurrences': 0, 'operational_role': 'trigger', 'trend_window': 96, 'breakout_z_threshold': 2.5, 'min_spacing': 192}`
- Tags: `['trend_momentum']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 48, 'min_occurrences': 0, 'operational_role': 'trigger', 'liquidation_spike_z_threshold': 3.0, 'cascade_window_bars': 12, 'vol_quantile': 0.992, 'ret_quantile': 0.998, 'range_quantile': 0.995}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 24, 'min_occurrences': 0, 'operational_role': 'trigger', 'breakout_window': 48, 'reversal_window': 12, 'breakout_strength_min': 0.003}`
- Tags: `['exhaustion']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'trend_window': 288, 'max_range_ratio': 8.0, 'breakout_z_threshold': 2.5}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 96, 'min_occurrences': 0, 'operational_role': 'trigger', 'slow_trend_quantile': 0.7, 'max_trend_persistence_bars': 72, 'liquidation_spike_z_threshold': 3.0, 'cascade_window_bars': 12}`
- Tags: `['exhaustion']`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'vol_lookback_window': 288, 'compression_quantile': 0.1, 'expansion_z_threshold': 2.5}`
- Tags: `['vol_regime']`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 6, 'min_occurrences': 5, 'operational_role': 'trigger'}`
...
- Thresholds: `{'merge_gap_bars': 0, 'cooldown_bars': 12, 'min_occurrences': 0, 'operational_role': 'trigger', 'vol_lookback_window': 96, 'compression_ratio_max': 0.8, 'compression_window': 6, 'min_breakout_distance': 0.0015, 'expansion_quantile': 0.85}`
...
- Thresholds: `{'merge_gap_bars': 1, 'cooldown_bars': 0, 'min_occurrences': 0, 'operational_role': 'trigger', 'phase_tolerance_bars': 16, 'shock_quantile': 0.9}`
- Tags: `['vol_regime', 'high_urgency']`
