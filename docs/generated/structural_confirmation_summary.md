...
- component_candidates: `THESIS_VOL_SHOCK`, `THESIS_LIQUIDITY_VACUUM`
- generated_bundle_count: `2`
- overlap_factor: `0.5`
- bundle_path: `edge_work/data/reports/promotions/THESIS_VOL_SHOCK_LIQUIDITY_CONFIRM/evidence_bundles.jsonl`
